									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												...
												<div class="product_price discount">${{$feature->selling_price}}</div>
												@else
												<div class="product_price discount">${{$feature->discount_price}}<span>${{$feature->selling_price}}</span></div>
												@endif
												<div class="product_name"><div><a href="{{url('product/details/'.$feature->id.'/'.$feature->product_name)}}">{{$feature->product_name}}</a></div></div>
							...
							<div class="row fill_height">
								<div class="col-lg-4 col-md-6 fill_height">
									<div class="banner_2_content">
										...
										<div class="banner_2_text"><h4>{{$mid->brand_name}}</h4><br>
											<h4 style="color: red;">${{$mid->selling_price}}<h4>
										</div>
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{asset($mid->image_one)}}" alt="" style="height: 300px; width: 250px"></div>
									</div>
								</div>
							</div>
						</div>			
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="featured_slider_item">
                    <div class="border_active"></div>
                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset( $product->image_one )}}" alt="" style="height: 120px; width: 100px;"></div>
                        <div class="product_content">
