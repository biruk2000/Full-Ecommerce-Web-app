			...
			<div class="row">
				<div class="col-lg-5 offset-lg-1" style="border: 1px solid grey; padding: 20px; border-radius: 25px">
					<div class="contact_form_container">
                        ...
                        <br>
                        <br>
                        <button type="submit" class="btn btn-primary btn-block"><i class="fab fa-facebook-square" style="margin-right: 10px"></i> Login with facebook</button>
                        <button type="submit" class="btn btn-danger btn-block"><i class="fab fa-google"  style="margin-right: 10px"></i>Login with Google</button>
					</div>
				</div>
					...
					<div class="contact_form_container">
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus placeholder="Enter Your Phone">
                                @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                           ...
                           <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password1" placeholder="Re-Type Password" name="password_confirmation" required="">
                            </div>
							<div class="contact_form_button">
